...
class VersionSorter {
    ...
    Result pickTaggedCommit(
        List<TagsOnCommit> taggedCommits,
        ...
        for (TagsOnCommit tagsEntry : taggedCommits) {
            ...
            boolean ignoreNextVersionOnHead = tagsEntry.isHead() && !tagsEntry.hasOnlyMatching(nextVersionTagPattern) && !forceSnapshot;
        ...
        return new Result(
            ...
            (versionCommit == null ? false : versionCommit.isHead())
        );
    }
    ...
    static class Result {
        ...
        private Result(Version version, boolean isNextVersion, boolean noTagsFound, String commit, boolean isHead) {
